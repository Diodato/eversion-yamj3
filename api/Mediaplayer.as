...
// ************************* QUEUE/PLAY FUNCTIONS ********************************
	...
	public static function resetQueue():Void {
		...
		Mediaplayer.datasource=new dataYAMJ3();
		...
		Mediaplayer.sdkpathsize=285524;
	...
	public static function addFromRaw(raw:Object, filename:String, callback:Function, parentMC:MovieClip) {
		...
		if(!Mediaplayer.insert_queue(raw.title, filename ,undefined, true)) return;
