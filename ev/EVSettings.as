...
class ev.EVSettings {
	...
	public function validateSettings() {
		...
		// yamj3
		if(Common.evSettings.yamj3chunksize==null || Common.evSettings.yamj3chunksize==undefined)
			Common.evSettings.yamj3chunksize='18';
		else if(int(Common.evSettings.yamj3chunksize) < 5)
			Common.evSettings.yamj3chunksize='5';
		if(Common.evSettings.yamj3librarypaths==null || Common.evSettings.yamj3librarypaths==undefined)
