...
//	private var ydata:dataYAMJ=null;
	private var ydata3:dataYAMJ3=null;
...
//							delete Common.eskincfile[this.filename];
	...
	private function do_insert(xml, postxml) {
	...
	private function insert_loadcat() {
		...
		this.ydata3=new dataYAMJ3();
		this.ydata3.getCat(this.fn.insert_load);
	}
