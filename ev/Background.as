...
class ev.Background {
	...
	public static var yamj3check:Boolean=null;
...
// **************** VERSION CHECKS **************************
	public static function vercheck() {
		...
		if(Common.yamj3isrunning==false)
		{
			Background.yamj3check=true;
			trace("YAMJ3 not running, alerting");
		}
		else
